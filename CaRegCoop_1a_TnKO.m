%% This function will take care of cooperativity for the TmSpan=37 nm
%% Depdens on the

function [TFstate]=CaRegCoop_1a_TnKO(NACT, NTn, TFstate, Tn, dt, CoopPass, TFRatePass, Ca, iCa, TnKO)
