...
function []=ton_pCa_Data_2013_7_31(dt, InDir, pCa, OutDirectory, XB_Fraction, Stats)
%function []=ton_pCa_Data_2013_7_31()

%dt = 0.001;
Figure_Number = 2;
% InDir = 'DataFiles\Rate_-0.10_SL_1210_-100nm\';
% OutDirectory = 'DataFiles\Rate_-0.10_SL_1210_-100nm\';
%XB_Fraction = 1;
SetNumber = 1;

ROIRange = ['A' 'B' 'C' 'D' 'E'];
% pCaRange = [4.00 5.50 5.80 6.00];

% RateRange = {'-0.10', '-0.25', '-0.50', '-1.00'};
% SLRange = {'1210', '1510'};
% ShortenRange = {'-100', '-50'};
...
%                     OutDirectory = ['DataFiles\Rate_',Rate,'_SL_',SL,'_',Shorten,'nm\'];
                    ...
                    SS_Data_Out_Avg=[mean(SS_Data_Out(:,1)), std(SS_Data_Out(:,1)),...
                        mean(SS_Data_Out(:,2)), std(SS_Data_Out(:,2)),...
                        mean(SS_Data_Out(:,3)), std(SS_Data_Out(:,3))];
