...
%% For the CaRegCoop_2b_TnKO, I have added the assumptions that the heads
%% cannot de-activate if a guy is bound in the region.  Expand the
%% assumptions from the 56 nm case to the 74 nm case.

function [TFstate]=CaRegCoop_3b_TnKO(NACT, NTn, TFstate, Tn, dt, CoopPass, TFRatePass, Ca, iCa, TnKO)
          ...
          case 0 %ACTNode off
            ...
            if (gx <= p01)
              ...
              if TnKO(iRow, iTn+1) == 0
                ...
                TFstate(ii+6,1) = Coop_2aTo1( TFstate(Tn(iRow, iTn+1), 1) );
          ...
          case 1 %ACTNode is in the intermediate position
            ...
            elseif (gx >= 1.0 - p10)
              ...
              if TnKO(iRow, iTn+1) == 0
                ...
                TFstate(ii+6,1) = TFstate(Tn(iRow, iTn+1), 1);
              end
            ...
            if (~ ( (TFstate(ii, 2)==2)||(TFstate(ii+2, 2)==2)) )
              ...
              if (gx <= p20)
                ...
                if TnKO(iRow, iTn+1) == 0
                  ...
                  if TFstate(ii+2,1)<2 && TFstate(ii+4,1)<2 && TFstate(ii+6,1)<2
                    TFstate(ii+2,2)=0;  TFstate(ii+2,3)=0;
                    TFstate(ii+4,2)=0;  TFstate(ii+4,3)=0;
                    TFstate(ii+6,2)=0;  TFstate(ii+6,3)=0;
                  end
                end
              ...
              elseif (gx >= 1.0 - p21)
                ...
                if TnKO(iRow, iTn+1) == 0
                  ...
                  TFstate(ii+6,1)=1;TFstate(ii+6,2)=0; TFstate(ii+6,3)=0;
                else
                  %% June 25, 2007
                  %% MOD:
