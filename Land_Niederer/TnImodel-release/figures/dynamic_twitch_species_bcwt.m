...
%function [] = dynamic_twitch_species_bcwt
addpath('./export_fig','..');
...
for split = {'','_nosplit'}
 ...
 disp('Writing Mouse data')
 time_Mouse_F=0:500;
 Mouse_F=K*fmouse(end-500:end);
 disp('Written Mouse data')
...
% %% BCWT MOD--Error on smothing figure; myfig2(figure(71), './Fig7a.png',[3.25 2.5]*2,225);
...
% %% BCWT MOD--Error on smothing figure; myfig2(figure(72), './Fig7b.png',[3.25 2.5]*2,225);
