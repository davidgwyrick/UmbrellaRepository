...
function [TFstate]=CaRegCoop_2a_TnKO(NACT, NTn, TFstate, Tn, dt, CoopPass, TFRatePass, Ca, iCa, TnKO)
                    ...
                    switch TFstate(ii, 1)
                        case 0 %ACTNode off
                            ...
                            if (gx <= p01)
                                ...
                                %% MOD: TFstate(ii-2,1)=?
                                %% and TFstate(ii+2,1)=?
                                %% now that TmSpan is we need to check left and
                                %% right with the iTnNext and iTnPrev equivalent
                                %% And modify the shared node accordingly
                                TFstate(ii+2,1) = Coop_2aTo1( TFstate(Tn(iRow, iTn+1), 1) );
                                TFstate(ii-2,1) = Coop_2aTo1( TFstate(Tn(iRow, iTn-1), 1) );
