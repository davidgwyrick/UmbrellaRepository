...
%     for jj=1:length(RuOff_range)
    ...
    for kk=1:length(pCa_Range)
        ...
        foldername=['keq3TFrates_koff=',num2str(Koff),' RuOff=',num2str(RuOff),' CaOff=',num2str(CaOff)];
...
label1=['koff=100 RuOff=5 CaOff=100 pCa50=',num2str(coeff1(3,1)),' nh=',num2str(coeff1(2,1))];
