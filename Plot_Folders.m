...
for iRate = 1:length(RateRange)
    Rate = num2str(RateRange(iRate),'%1.2f');
        ...
        for iSXB2 = 1:length(SXB2_Range)
            ...
            for iSXB3 = 1:length(SXB3_Range)
                ...
                for ipCa = 1:length(pCa_Range)
                    ...
                    filepath = ['DataFiles/',foldername,'SS_ton_AVG_pCa_',pCa,'_ROI_A.txt'];
                    ...
                    filepath = ['DataFiles/',foldername,'SSData_pCa_',pCa,'_ROI_A.txt'];
                    Data = importdata(filepath);
...
set(gca,'visible','off')
text(0.2,0.4, sprintf('For SXB2 of 0.5 and SXB3 of 0.1\nFmax = %4.2f (STD %4.2f)\nHill Coeff = %4.2f (STD %4.2f)\npCa50 = %4.2f [%4.2f to %4.2f] (STD %4.2f)\n\nFor SXB2 of 1 and SXB3 of 1\nFmax = %4.2f (STD %4.2f)\nHill Coeff = %4.2f (STD %4.2f)\npCa50 = %4.2f [%4.2f to %4.2f] (STD %4.2f)\n',coeff1(1,1), coeff1(1,2), coeff1(2,1), coeff1(2,2), coeff1(3,1), coeff1(3,4),coeff1(3,5),coeff1(3,2),coeff2(1,1), coeff2(1,2), coeff2(2,1), coeff2(2,2), coeff2(3,1), coeff2(3,4),coeff2(3,5),coeff2(3,2)), 'parent', h2);
